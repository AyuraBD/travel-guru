        ...
        <div className="p-5 border-2 lg:w-1/2 m-auto">
          ...
          <form onSubmit={handleSignUp} className="card-body pt-3 px-0 pb-0">
            <div className="form-control">
              <input type="text" name="firstName" placeholder="First name" className="py-2 px-2 border-b focus:outline-0 placeholder:text-slate-700" required />
            </div>
            <div className="form-control">
              <input type="text" name="lastName" placeholder="Last name" className="py-2 px-2 border-b focus:outline-0 placeholder:text-slate-700" required />
            </div>
            <div className="form-control">
              <input type="text" name="email" placeholder="Username or Email" className="py-2 px-2 border-b focus:outline-0 placeholder:text-slate-700" required />
            </div>
            ...
            <div className="mt-5">
              <input type="submit" value="Create an account" className="bg-[#F9A51A] w-full  py-2 text-black font-semibold cursor-pointer"/>
            </div>
            <div className="mt-3 text-center">
              <p>Already have an account? <Link to='/login' className="text-yellow-500">Login</Link></p>
            </div>
          </form>
        </div>
